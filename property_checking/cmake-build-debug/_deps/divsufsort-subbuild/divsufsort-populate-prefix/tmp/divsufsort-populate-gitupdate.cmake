...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "2.0.1"
  WORKING_DIRECTORY "/Users/yuhong/CLionProjects/rapid_check/cmake-build-debug/_deps/divsufsort-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("2.0.1" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/2.0.1")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/yuhong/CLionProjects/rapid_check/cmake-build-debug/_deps/divsufsort-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/yuhong/CLionProjects/rapid_check/cmake-build-debug/_deps/divsufsort-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
